...
public class TestCases_ddi extends Settings {
    ...
    @Test(priority = 1, groups = "smoke")
    public void verify_links_pr_manager() {
        Management.verify_links_pr_manager();
    }
    ...
    @Test(priority = 1, groups = "smoke")
    public void portfolio_tabs_exist_and_works() {
        Portfolio.tabs_exist_and_works();
    }

    @Test(priority = 1, groups = "smoke")
    public void send_request_home_page() {
    ...
    @Test(priority = 1, groups = "smoke")
    public void contact_us_link_present() {
    ...
    public void compare_screen() {
        HomePage.compare_home_page_screen();
    }
