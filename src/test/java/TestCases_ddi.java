...
public class TestCases_ddi extends Settings
{
    ...
    @Test(priority = 1, groups = "smoke")
    public void zoom_map_contact_us() {ContactUs.zoom_in_and_zoom_out_map();}
    @Test(priority = 1, groups = "smoke")
    public void company_links_verify_present(){Company.company_links_present();}
    @Test(priority = 1, groups = "smoke")
    public void change_tabs_how_we_work(){HowWeWork.change_tabs();}
    @Test(priority = 1, groups = "smoke")
    public void hww_links_verify_present(){HowWeWork.how_we_work_present();}
    @Test(priority = 1, groups = "smoke")
